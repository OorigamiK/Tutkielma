...
\begin{document}
	...
	\begin{itemize}
		\item $RV_\alpha^+$ – eventually monotonic regularly varying functions locally bounded away from $0$ and $\infty$ with index $\alpha$ (see \cite{bingham1987regular}). We assume the domain and range are $\mathbb{R}_{>0}$.
