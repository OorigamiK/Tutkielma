...
\begin{document}
	...
	\begin{proof}
		...
		\begin{align}
			\sum_{i=1}^{n\epsilon} f^{-1}(\frac{x}{i})&=\sum_{i=1}^{n\epsilon} (\frac{x}{i})^{\frac{1}{\alpha}}\tilde{L}(\frac{x}{i})\notag\\
			&=x^{\frac{1}{\alpha}}\sum_{i=1}^{n\epsilon} i^{-\frac{1}{\alpha}}\tilde{L}(\frac{x}{i})\notag\\
			&\le x^{\frac{1}{\alpha}}\sum_{j=1}^{K} \sum_{i=n\epsilon^{j+1}}^{n\epsilon^j} i^{-\frac{1}{\alpha}} \tilde{L}(\frac{x}{i})\notag\\
			&\sim x^{\frac{1}{\alpha}}\sum_{j=1}^{K} \int_{n\epsilon^{j+1}}^{n\epsilon^j} t^{-\frac{1}{\alpha}} \tilde{L}(\frac{x}{t})\notag
		\end{align}
		Now we can use uniform convergence theorem on $\tilde{L}$
		\begin{align}
			x^{\frac{1}{\alpha}}\sum_{j=1}^{K} \int_{n\epsilon^{j+1}}^{n\epsilon^j} t^{-\frac{1}{\alpha}} \tilde{L}(\frac{x}{t})dt&\sim 
			x^{\frac{1}{\alpha}}\sum_{j=1}^{K} \int_{n\epsilon^{j+1}}^{n\epsilon^j} t^{-\frac{1}{\alpha}} \tilde{L}(\frac{x}{n\epsilon^j})dt\notag\\
			&=\frac{\alpha}{\alpha-1}x^{\frac{1}{\alpha}}\sum_{j=1}^{K} \tilde{L}(\frac{x}{n\epsilon^{j}})
			((n\epsilon^j)^{1-\frac{1}{\alpha}}-(n\epsilon^{j+1})^{1-\frac{1}{\alpha}})\notag\\
			&=\frac{\alpha}{\alpha-1}x^{\frac{1}{\alpha}}(1-\epsilon^{1-\frac{1}{\alpha}})
			\sum_{j=1}^{K} \tilde{L}(\frac{x}{n\epsilon^{j}})
			(n\epsilon^j)^{1-\frac{1}{\alpha}}\notag\\
			&=\frac{\alpha}{\alpha-1}x^{\frac{1}{\alpha}}n^{1-\frac{1}{\alpha}}(1-\epsilon^{1-\frac{1}{\alpha}})
			\sum_{j=1}^{K} \tilde{L}(\frac{x}{n\epsilon^{j}})
			\epsilon^{j(1-\frac{1}{\alpha})}\notag
		\end{align}
		Clearly
		\[
		\frac{\alpha}{\alpha-1}x^{\frac{1}{\alpha}}n^{1-\frac{1}{\alpha}}(1-\epsilon^{1-\frac{1}{\alpha}})=O(n^2 L(n)^{\frac{1}{\alpha}}).
		\]
		So it is enough to show that
		\[
		\tilde{L}(\frac{x}{n\epsilon^{j}})L(n)^{\frac{1}{\alpha}}\sim 1
		\]
		We know that
		\begin{align}
		f^{-1}(f(n))=n\notag\\
