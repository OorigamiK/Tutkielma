...
\begin{document}
	...
	\]
	where $x\sim \frac{nf(n)}{\alpha+1}, x\to\infty$ and \[C(\alpha)=\frac{1}{2(\alpha+1)}
	\frac{\Gamma(\frac{1}{\alpha+1})\Gamma(\frac{\alpha-1}{\alpha+1})}{\Gamma(\frac{\alpha}{\alpha+1})}\] for a regularly varying function $f$ with index $\alpha>1$ that satisfies certain assumptions.
