...
\begin{document}
	...
	\begin{proof}
		...
		\end{align}
		Now if the convergence is not uniform there exists $\epsilon_0>0$ and for all $X_0>0$ such that there exists $x>X_0$ and $\lambda_x\in[\epsilon,1-\epsilon]$ such that 
		...
		We know that 
		\begin{align}
			((\phi^{-1}(\lambda)(1+\epsilon_0)+\lambda)^{\alpha+1}-((\phi^{-1}(\lambda)(1+\epsilon_0))^{\alpha+1})=1+F(\lambda)
		\end{align}
