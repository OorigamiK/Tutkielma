...
\begin{document}
	...
	\begin{itemize}
		...
		We often omit the "$x\to a$" part, when it is clear from context, usually.
	...
	\begin{proof}
		...
		\end{align}
		Since the uniform convergence theorem applies uniformly this asymptotic converges also uniformly.
	\end{proof}
	...
	\begin{lemma}\label{head's neglible}
		...
		\end{align}
		Where $O(n^2)$ is independent of $\epsilon$.
	\end{lemma}
	...
	\begin{proof}
		...
		\end{align}
		Using relation of $x$ and $n$ obtained in Lemma~\ref{sum f Asymp}
		\begin{align}
